...
object DeviceInfoUtils : SettingsLibDeviceInfoUtils() {
    ...
    private const val PROP_ALLOW_MAJOR_UPGRADES = "los.updater.allow_major_upgrades"
    private const val PROP_BUILD_DATE = "ro.build.date.utc"
    private const val PROP_BUILD_VERSION = "ro.los.build.version"
    private const val PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental"
    private const val PROP_DEVICE = "ro.los.device"
    private const val PROP_NEXT_DEVICE = "ro.updater.next_device"
    private const val PROP_RELEASE_TYPE = "ro.los.releasetype"
    private const val PROP_UPDATER_ALLOW_DOWNGRADING = "los.updater.allow_downgrading"
    private const val PROP_UPDATER_URI = "los.updater.uri"
